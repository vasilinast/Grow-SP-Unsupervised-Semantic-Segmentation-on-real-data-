...
import numpy as np
import random
from datasets.ConstSite import ConstSite, cfl_collate_fn
import torch
...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str, default='data/construct_site/input/test2',
                        help='pont cloud data path')
    parser.add_argument('--sp_path', type=str, default='data/construct_site/initial_superpoints/test2/',
    ...
    parser.add_argument('--select_num', type=int, default=6, help='scene number selected in each round') ########1500
