...
def parse_args():
    ...
    parser.add_argument('--vis_path', type=str, default='/workspace/data/construct_site/input/test/results/',
                         help='pnt cloud vis path')
    parser.add_argument('--data_path', type=str, default='/workspace/data/construct_site/input/test',
                        help='pont cloud data path')
    parser.add_argument('--sp_path', type=str, default='',
                        help='initial superpoint path')
    parser.add_argument('--save_path', type=str, default='/workspace/data/construct_site/input/test/models/',
                        help='model savepath')
    ###
...
def eval(epoch, args, test_areas = ['Area_5']):
    ...
    test_dataset = ConstSitetest(args)
...
if __name__ == '__main__':
    ...
    args = parse_args()
    for epoch in range(10, 1240):
        if epoch % 1230 == 0:
            score = eval(epoch, args)
