...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str, default='/workspace/extracted_data/DATA-HTCV/tests/test_data_PLY/',
                        help='pont cloud data path')
    parser.add_argument('--sp_path', type=str, default='/workspace/extracted_data/DATA-HTCV/tests/test_data_SP',
